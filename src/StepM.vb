...
#Region "StepM_ShowStep"
    Private Sub StepM_Validation(sender As Object, e As System.ComponentModel.CancelEventArgs) Handles Me.ValidateStep
        ...
        'By default the count variable will be 1;
            ...
            Else 'ERROR!
                ...
                CenteredMessagebox.MsgBox.Show("StepM: Loop Logic Error (Error Code 142857)", "ERROR!", MessageBoxButtons.OK, MessageBoxIcon.Error)
            End If
    End Sub
